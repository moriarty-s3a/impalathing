...
func (p *ImpalaServiceClient) Cancel(query_id *beeswax.QueryHandle) (r *status.TStatus, err error) {
  if err = p.sendCancel(query_id); err != nil { return }
  return p.recvCancel()
}
...
func (p *ImpalaServiceClient) CloseInsert(handle *beeswax.QueryHandle) (r *TInsertResult_, err error) {
  if err = p.sendCloseInsert(handle); err != nil { return }
...
func (p *ImpalaServiceClient) PingImpalaService() (err error) {
  if err = p.sendPingImpalaService(); err != nil { return }
...
func (p *ImpalaHiveServer2ServiceClient) ResetCatalog() (r *status.TStatus, err error) {
  if err = p.sendResetCatalog(); err != nil { return }
